...
public class TopicExchangeConfig {
    ...
    public Queue queueMessageA() {
        return new Queue("topic_message_a");
    }
    ...
    public Queue queueMessageB() {
        return new Queue("topic_message_b");
    }
    ...
    public Binding bindingExchangeMessageA(Queue queueMessageA, TopicExchange exchange) {
        return BindingBuilder.bind(queueMessageA).to(exchange).with("topic.message");//routingKey,匹配规则
    }
